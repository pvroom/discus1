...
export class HomePage {
	...
	constructor(public navCtrl: NavController, 
				...
				pltfrm.ready().then(() => {
					...
					this.AppTitleHeader = "Public Policy Conference";
		...
		if (LoginName != '' && LoginName != null && LoginName != 'undefined') {
			...
			if (DevPlatform == 'iOS' || DevPlatform == 'Android') {
				...
				*/
				...
				var randNum = Math.floor((Math.random() * 100) + 1);
				if (FlyinBanner == null) {
					this.appBanner = 'https://discus.convergence-us.com/AdminGateway/images/FlyinBanners/default.png?rnd=' + randNum;
				} else {
					if (FlyinBanner.length==0) {
						this.appBanner = 'https://discus.convergence-us.com/AdminGateway/images/FlyinBanners/default.png?rnd=' + randNum;
					} else {
						// Banner from server images folder
						this.appBanner = 'https://discus.convergence-us.com/AdminGateway/images/FlyinBanners/' + FlyinBanner + '?rnd=' + randNum;
					}
				}
			}
